...
const SectionPortfolio = () => {
  ...
  return (
    <section id="portfolio" className=" p-[70px]">
      <div className={cn("flex flex-col items-center justify-center w-full h-full")}>
        ...
        <MatrixCard>
          ...
          >
            {portfolioData.map((a) => {
              return (
                <div key={a.name} className="bg-[#ffffff]">
                  <div
                    style={{
      ...
      <Dialog fullScreen open={open} onClose={handleClose}>
        <div className="w-full h-full">
          ...
          <div className="p-[40px] flex flex-col items-center justify-center">
            <div className="mb-[20px] text-[24px] font-bold text-center">
              {dialogData.name}
            </div>
            <Image
              src={dialogData.imgUrl}
              alt={dialogData.name}
              width={500}
              height={500}
            ></Image>
            ...
            {dialogData.projectUrl && (
              <NeonButton variant="cyan" onClick={() => {}}>
                <a href={dialogData?.projectUrl} target="_blank">
                  {t("跳转到项目")}
                </a>
              </NeonButton>
            )}
